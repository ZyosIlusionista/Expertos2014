 ...
 */
class Permisos extends \Entidades\Expertos\Permisos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entidades\\Expertos\\Permisos' . "\0" . 'id', '' . "\0" . 'Entidades\\Expertos\\Permisos' . "\0" . 'nombre', '' . "\0" . 'Entidades\\Expertos\\Permisos' . "\0" . 'estado');
        }
