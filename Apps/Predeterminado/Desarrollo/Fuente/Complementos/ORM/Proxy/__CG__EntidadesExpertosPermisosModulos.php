 ...
 */
class PermisosModulos extends \Entidades\Expertos\PermisosModulos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entidades\\Expertos\\PermisosModulos' . "\0" . 'id', '' . "\0" . 'Entidades\\Expertos\\PermisosModulos' . "\0" . 'nombre', '' . "\0" . 'Entidades\\Expertos\\PermisosModulos' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PermisosModulos $proxy) {
