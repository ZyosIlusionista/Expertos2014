<?php
	...
	class Desarrollo extends Command {
		...
		/**
		 * Desarrollo::appDirectorioLectura()
		 * 
		...
		/**
		 * Desarrollo::appConsolaDirectorio()
		 * 
		...
		/**
		 * Desarrollo::appConsolaDirectorioLectura()
		 * 
		...
		/**
		 * Desarrollo::appConsolaExistencia()
		 * 
		...
		/**
		 * Desarrollo::consolaObjetoMetodo()
		 * 
		...
		/**
		 * Desarrollo::consolaObjetoEjecutar()
		 * 
